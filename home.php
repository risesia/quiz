    ...
    <div class="responsive-padding responsive-flex align-items-center justify-content-center gap-1">
      <div class="column">
        <div class="tulisan-home">
          <h1 class="font-atas text-white responsive-font fw-semibold fs-1">
            Ayo <span>semangat
            </span> ikutin quiznya ya,
            <span class="text-primary">

                <?php
                $result = mysqli_query($conn,"select nama_siswa from siswa WHERE nis = " . $_SESSION['user'] . " limit 1");
        ...
        <div class="responsive-button">
          <a class="btn btn-primary" type="button" href="quizz.php">Quiza</a>
          <a class="btn btn-outline-primary" type="button" href="materi.html">Materi</a>
          <a class="btn btn-outline-primary" type="button" href="about.html">Tentang</a>
          <a class="btn btn-outline-primary" type="button" href="profil.php">Profil</a>
      ...
      <a href="https://www.unimed.ac.id" class="responsive-logo">
       <img class="responsive-logo" src="assets/unimednoLogo.png" alt="logo unimed" />
        <!--<img class="responsive-logo" src="assets/unimed.png" alt="logo unimed" />-->
      </a>
    </div>
  </main>
